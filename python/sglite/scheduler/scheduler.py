...
from sglite.core import Batch, Req
from sglite.env import ENV
from sglite.message import (
    BaseBackendMsg,
    BatchBackendMsg,
    DetokenizeMsg,
    ExitMsg,
...
from sglite.utils import init_logger
...
if TYPE_CHECKING:
    from sglite.engine import BatchSamplingArgs, ForwardOutput
...
class Scheduler(SchedulerIOMixin):
    def __init__(self, config: SchedulerConfig):
        from sglite.engine import Engine
    ...
    def _forward(self, forward_input: ForwardInput) -> ForwardOutput:
        ...
        if ENV.OVERLAP_EXTRA_SYNC:  # NOTE: https://github.com/sgl-project/sglite/issues/58
