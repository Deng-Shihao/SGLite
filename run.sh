...
# python -m sglite --model "Qwen/Qwen3-4B"

# Deploy Qwen/Qwen3-4B with TP
# python -m sglite --model "Qwen/Qwen3-4B" --tp 2
...
# Shell Bench
python -m sglite --model Qwen/Qwen3-8B --cli-bench
python -m sglite --model Qwen/Qwen3-8B-AWQ --cli-bench
