...
import torch
from sglite.attention import create_attention_backend
from sglite.core import Batch, Context, Req, set_global_ctx
from sglite.distributed import destroy_distributed, enable_pynccl_distributed, set_tp_info
from sglite.kvcache import create_kvcache
from sglite.layers import set_rope_device
from sglite.models import create_model, load_hf_weight
from sglite.utils import divide_even, init_logger, torch_dtype
...
class Engine:
    ...
    def _load_weight_state_dict(self, config: EngineConfig) -> Dict[str, torch.Tensor]:
        ...
        if config.use_dummy_weight:
            ...
            return {
                # if k, v is .qweight & .qzeros note change dtype
